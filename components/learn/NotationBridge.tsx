    ...
    <figure className="notation-bridge">
      ...
      >
        ...
        <g stroke="rgba(255,255,255,0.2)" strokeWidth="0.75">
          <line x1="55" y1="55" x2="175" y2="55" />
          <line x1="55" y1="70" x2="175" y2="70" />
          <line x1="55" y1="85" x2="175" y2="85" />
          <line x1="55" y1="100" x2="175" y2="100" />
          <line x1="55" y1="115" x2="175" y2="115" />
        </g>
        ...
        <ellipse cx="125" cy="100" rx="9" ry="6.5"
          fill="#F3BB7D" transform="rotate(-10,125,100)" />

        {/* B4 on middle line (y=85) */}
        <ellipse cx="125" cy="85" rx="9" ry="6.5"
          fill="#9DE698" transform="rotate(-10,125,85)" />

        {/* D5 on second line from top (y=70) */}
        <ellipse cx="125" cy="70" rx="9" ry="6.5"
          fill="#D4D087" transform="rotate(-10,125,70)" />

        {/* Stem */}
        <line x1="134" y1="70" x2="134" y2="44"
          stroke="rgba(255,255,255,0.6)" strokeWidth="1.5" />

        {/* ── Pitch labels beside note heads ── */}
        <text x="145" y="104" fontFamily="'Space Mono', monospace" fontSize="10"
          fill="#F3BB7D" opacity="0.8">G</text>
        <text x="145" y="89" fontFamily="'Space Mono', monospace" fontSize="10"
          fill="#9DE698" opacity="0.8">B</text>
        <text x="145" y="74" fontFamily="'Space Mono', monospace" fontSize="10"
